...
st.image("Customer-Lifetime-value-new-1.png")
data = st.file_uploader("File Uploader")
st.sidebar.markdown(""" **Made with :heart: by Shubham** """)

st.sidebar.title("Input Features :pencil:")

st.sidebar.markdown("""

[Example CSV Input File](https://github.com/shubham8all/Customer_LifeTime_Prediction/blob/main/Model%20Deployment/sample_file.csv)
...
st.markdown(
    """
    <style>
        /* Modify slider handle color */
        .css-1c7h4fs.e1vzey7j1 { 
            background: #94D111;
        }
        /* Modify slider track color */
        .css-1gsznyl.e1vzey7j0 {
            background: #94D111;
        }
    </style>
    """,
